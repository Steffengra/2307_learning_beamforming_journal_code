...
if __name__ == '__main__':
    ...
    data_paths = [
        Path(cfg.output_metrics_path,
             ...
             'testing_mmse_sweep_0.0_0.1_other_error.gzip'),
        Path(cfg.output_metrics_path,
             '1sat_16ant_100k~0_3usr_100k~50k', 'error_sweep',
             'testing_robust_slnr_sweep_0.0_0.1_other_error.gzip'),
        Path(cfg.output_metrics_path,
             '1sat_16ant_100k~0_3usr_100k~50k', 'error_sweep',
             'testing_learned_0.0_0.0_sweep_0.0_0.1_other_error.gzip'),
        Path(cfg.output_metrics_path,
             '1sat_16ant_100k~0_3usr_100k~50k', 'error_sweep',
             'testing_learned_0.0_sweep_0.0_0.1_other_error.gzip'),
        Path(cfg.output_metrics_path,
             '1sat_16ant_100k~0_3usr_100k~50k', 'error_sweep',
             'testing_learned_0.025_sweep_0.0_0.1_other_error.gzip'),
    ]
    ...
    plot_legend = [
        'MMSE',
        'SLNR',
        'SAC $\Delta\epsilon=\sigma=0.0$',
        'SAC $\Delta\epsilon=0.025,\sigma=0$',
        'SAC $\Delta\epsilon=\sigma=0.025$',
    ]
    ...
    plot_error_sweep_testing_graph(
        paths=data_paths,
        name='error_sweep_other_error_model',
        width=plot_width,
        xlabel='Error Scale $\sigma_{\mathrm{ph}}$',

...
def main():
    ...
    learn_adapt_slnr(user_dist=100_000, user_wiggle=50_000, additive_error_on_cosine_of_aod=0.00, testing_range=testing_error_sweep_range_100k)
    learn_adapt_slnr(user_dist=100_000, user_wiggle=50_000, additive_error_on_cosine_of_aod=0.05, testing_range=testing_error_sweep_range_100k)
